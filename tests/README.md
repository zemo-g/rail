...
Expected: `178/178` on macOS ARM64. The count fluctuates only when
...
The 178 cases are grouped in `tools/compile.rail` under `test_main`:
...
- crypto (SHA-256/HMAC/HKDF/ChaCha20-Poly1305/x25519), TLS 1.3 message parsers
