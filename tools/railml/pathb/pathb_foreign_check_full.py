...
#
# Usage:
#   python3 pathb_foreign_check_full.py [artifact] [attestation.json] [pubkey.pem]
# Defaults:
#   artifact         = tools/railml/pathb/logits_full.txt  (relative to this file)
...
def main():
    ...
    artifact = sys.argv[1] if len(sys.argv) > 1 else os.path.join(here, "logits_full.txt")
